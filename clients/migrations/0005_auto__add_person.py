...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Person'
        db.create_table(u'clients_person', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=254)),
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('cellphone', self.gf('django.db.models.fields.CharField')(max_length=14)),
        ))
        db.send_create_signal(u'clients', ['Person'])

        # Adding M2M table for field roles on 'Person'
        m2m_table_name = db.shorten_name(u'clients_person_roles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'clients.person'], null=False)),
            ('role', models.ForeignKey(orm[u'clients.role'], null=False))
        ))
        db.create_unique(m2m_table_name, ['person_id', 'role_id'])

        # Adding model 'Role'
        db.create_table(u'clients_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('mandatory', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'clients', ['Role'])


    def backwards(self, orm):
        # Deleting model 'Person'
        db.delete_table(u'clients_person')

        # Deleting model 'Role'
        db.delete_table(u'clients_role')

        # Removing M2M table for field roles on 'Person'
        db.delete_table(db.shorten_name(u'clients_person_roles'))
    ...
    models = {
        ...
        u'clients.person': {
            ...
            'cellphone': ('django.db.models.fields.CharField', [], {'max_length': '14'}),
