...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.cnpj'
        db.alter_column(u'clients_client', 'cnpj', self.gf('django.db.models.fields.CharField')(max_length=19, unique=True, null=True))
        # Adding unique constraint on 'Client', fields ['cnpj']
        db.create_unique(u'clients_client', ['cnpj'])


    def backwards(self, orm):
        # Removing unique constraint on 'Client', fields ['cnpj']
        db.delete_unique(u'clients_client', ['cnpj'])


        # Changing field 'Client.cnpj'
        db.alter_column(u'clients_client', 'cnpj', self.gf('django.db.models.fields.CharField')(default='', max_length=19))
