...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module.syllabus'
        db.add_column(u'exercises_module', 'syllabus',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.syllabus'
        db.delete_column(u'exercises_module', 'syllabus')
    ...
    models = {
        ...
        u'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 28, 0, 0)'})
        },
