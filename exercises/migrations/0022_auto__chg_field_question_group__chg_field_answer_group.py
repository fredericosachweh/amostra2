...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.group'
        db.alter_column(u'exercises_question', 'group', self.gf('django.db.models.fields.SlugField')(max_length=20))

        # Changing field 'Answer.group'
        db.alter_column(u'exercises_answer', 'group', self.gf('django.db.models.fields.SlugField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Question.group'
        db.alter_column(u'exercises_question', 'group', self.gf('django.db.models.fields.SlugField')(max_length=10))

        # Changing field 'Answer.group'
        db.alter_column(u'exercises_answer', 'group', self.gf('django.db.models.fields.SlugField')(max_length=10))
    ...
    models = {
        ...
        u'exercises.answer': {
            ...
            'group': ('django.db.models.fields.SlugField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
