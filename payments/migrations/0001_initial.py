...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payments_payment', (
            ...
            ('was_paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'payments', ['Payment'])

        # Adding M2M table for field klasses on 'Payment'
        m2m_table_name = db.shorten_name(u'payments_payment_klasses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('payment', models.ForeignKey(orm[u'payments.payment'], null=False)),
            ('klass', models.ForeignKey(orm[u'clients.klass'], null=False))
        ))
        db.create_unique(m2m_table_name, ['payment_id', 'klass_id'])

        # Adding model 'KlassPayment'
        db.create_table(u'payments_klasspayment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('klass', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Klass'])),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.Payment'])),
            ('created_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('update_at', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('current_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
        ))
        db.send_create_signal(u'payments', ['KlassPayment'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field klasses on 'Payment'
        db.delete_table(db.shorten_name(u'payments_payment_klasses'))

        # Deleting model 'KlassPayment'
        db.delete_table(u'payments_klasspayment')
    ...
    models = {
        ...
        u'payments.klasspayment': {
            ...
            'update_at': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
        u'payments.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'klasses': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['clients.Klass']", 'symmetrical': 'False'}),
