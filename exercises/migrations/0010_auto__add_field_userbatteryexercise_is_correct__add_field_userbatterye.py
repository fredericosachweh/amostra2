...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserBatteryExercise.is_correct'
        db.add_column('exercises_userbatteryexercise', 'is_correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserBatteryExercise.time_spent'
        db.add_column('exercises_userbatteryexercise', 'time_spent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserBatteryExercise.is_correct'
        db.delete_column('exercises_userbatteryexercise', 'is_correct')

        # Deleting field 'UserBatteryExercise.time_spent'
        db.delete_column('exercises_userbatteryexercise', 'time_spent')
