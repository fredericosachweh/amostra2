...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserBattery.correct_answers'
        db.add_column('exercises_userbattery', 'correct_answers',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserBattery.exercises_count'
        db.add_column('exercises_userbattery', 'exercises_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserBattery.correct_answers'
        db.delete_column('exercises_userbattery', 'correct_answers')

        # Deleting field 'UserBattery.exercises_count'
        db.delete_column('exercises_userbattery', 'exercises_count')
