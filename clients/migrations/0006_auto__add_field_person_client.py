...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.client'
        db.add_column(u'clients_person', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Client'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.client'
        db.delete_column(u'clients_person', 'client_id')
