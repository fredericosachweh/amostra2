...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgramUsage.end_date'
        db.add_column('exercises_programusage', 'end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 12, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgramUsage.end_date'
        db.delete_column('exercises_programusage', 'end_date')
