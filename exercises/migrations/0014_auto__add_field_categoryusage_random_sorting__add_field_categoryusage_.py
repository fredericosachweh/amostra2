...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryUsage.random_sorting'
        db.add_column('exercises_categoryusage', 'random_sorting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CategoryUsage.filter1_upper'
        db.add_column('exercises_categoryusage', 'filter1_upper',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=9, blank=True),
                      keep_default=False)

        # Adding field 'CategoryUsage.filter1_lower'
        db.add_column('exercises_categoryusage', 'filter1_lower',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=9, blank=True),
                      keep_default=False)

        # Adding field 'CategoryUsage.filter2_upper'
        db.add_column('exercises_categoryusage', 'filter2_upper',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=9, blank=True),
                      keep_default=False)

        # Adding field 'CategoryUsage.filter2_lower'
        db.add_column('exercises_categoryusage', 'filter2_lower',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=9, blank=True),
                      keep_default=False)

        # Adding field 'Exercise.filter1'
        db.add_column('exercises_exercise', 'filter1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=9, blank=True),
                      keep_default=False)

        # Adding field 'Exercise.filter2'
        db.add_column('exercises_exercise', 'filter2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=9, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryUsage.random_sorting'
        db.delete_column('exercises_categoryusage', 'random_sorting')

        # Deleting field 'CategoryUsage.filter1_upper'
        db.delete_column('exercises_categoryusage', 'filter1_upper')

        # Deleting field 'CategoryUsage.filter1_lower'
        db.delete_column('exercises_categoryusage', 'filter1_lower')

        # Deleting field 'CategoryUsage.filter2_upper'
        db.delete_column('exercises_categoryusage', 'filter2_upper')

        # Deleting field 'CategoryUsage.filter2_lower'
        db.delete_column('exercises_categoryusage', 'filter2_lower')

        # Deleting field 'Exercise.filter1'
        db.delete_column('exercises_exercise', 'filter1')

        # Deleting field 'Exercise.filter2'
        db.delete_column('exercises_exercise', 'filter2')
    ...
    models = {
        ...
        'clients.klass': {
            ...
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'taught_klasses'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'clients.teacher': {
        ...
        'exercises.categoryusage': {
            ...
            'filter1_lower': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '17', 'decimal_places': '9', 'blank': 'True'}),
            'filter1_upper': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '17', 'decimal_places': '9', 'blank': 'True'}),
            'filter2_lower': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '17', 'decimal_places': '9', 'blank': 'True'}),
            'filter2_upper': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '17', 'decimal_places': '9', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'random_sorting': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'exercises.chance': {
        ...
        'exercises.exercise': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'filter1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '17', 'decimal_places': '9', 'blank': 'True'}),
            'filter2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '17', 'decimal_places': '9', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'exercises.userbattery': {
            ...
            'score': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '5'}),
