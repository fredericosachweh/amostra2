...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demonstration.valid_until'
        db.alter_column(u'demonstrations_demonstration', 'valid_until', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Demonstration.valid_until'
        db.alter_column(u'demonstrations_demonstration', 'valid_until', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 25, 0, 0)'})
        },
        u'exercises.subject': {
