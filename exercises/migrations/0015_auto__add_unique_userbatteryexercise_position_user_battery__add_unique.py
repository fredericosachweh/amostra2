...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserBatteryExercise', fields ['position', 'user_battery']
        db.create_unique('exercises_userbatteryexercise', ['position', 'user_battery_id'])

        # Adding unique constraint on 'Chance', fields ['user_battery_exercise', 'number']
        db.create_unique('exercises_chance', ['user_battery_exercise_id', 'number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Chance', fields ['user_battery_exercise', 'number']
        db.delete_unique('exercises_chance', ['user_battery_exercise_id', 'number'])

        # Removing unique constraint on 'UserBatteryExercise', fields ['position', 'user_battery']
        db.delete_unique('exercises_userbatteryexercise', ['position', 'user_battery_id'])
    ...
    models = {
        ...
        'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 8, 0, 0)'})
        },
        'exercises.question': {
