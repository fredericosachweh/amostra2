...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionType.repeat'
        db.delete_column('exercises_questiontype', 'repeat')

        # Adding field 'QuestionType.group_short'
        db.add_column('exercises_questiontype', 'group_short',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=10),
                      keep_default=False)

        # Deleting field 'AnswerType.repeat'
        db.delete_column('exercises_answertype', 'repeat')

        # Adding field 'AnswerType.group_short'
        db.add_column('exercises_answertype', 'group_short',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'AnswerType.next_group'
        db.add_column('exercises_answertype', 'next_group',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Answer.tabindex'
        db.add_column('exercises_answer', 'tabindex',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QuestionType.repeat'
        db.add_column('exercises_questiontype', 'repeat',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'QuestionType.group_short'
        db.delete_column('exercises_questiontype', 'group_short')

        # Adding field 'AnswerType.repeat'
        db.add_column('exercises_answertype', 'repeat',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'AnswerType.group_short'
        db.delete_column('exercises_answertype', 'group_short')

        # Deleting field 'AnswerType.next_group'
        db.delete_column('exercises_answertype', 'next_group')

        # Deleting field 'Answer.tabindex'
        db.delete_column('exercises_answer', 'tabindex')
    ...
    models = {
        ...
        'exercises.answertype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'next_group': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
        'exercises.battery': {
        ...
        'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 26, 0, 0)'})
        },
        'exercises.question': {
