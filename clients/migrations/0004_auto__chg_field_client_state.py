...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.state'
        db.alter_column(u'clients_client', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Client.state'
        db.alter_column(u'clients_client', 'state', self.gf('django.db.models.fields.CharField')(max_length=150))
