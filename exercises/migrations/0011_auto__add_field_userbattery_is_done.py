...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserBattery.is_done'
        db.add_column('exercises_userbattery', 'is_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserBattery.is_done'
        db.delete_column('exercises_userbattery', 'is_done')
