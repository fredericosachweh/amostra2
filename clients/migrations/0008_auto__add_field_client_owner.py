...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.owner'
        db.add_column(u'clients_client', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='clients', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.owner'
        db.delete_column(u'clients_client', 'owner_id')
    ...
    models = {
        ...
        u'clients.client': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'clients'", 'null': 'True', 'to': u"orm['auth.User']"}),
