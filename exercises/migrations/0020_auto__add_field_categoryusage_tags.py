...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryUsage.tags'
        db.add_column(u'exercises_categoryusage', 'tags',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryUsage.tags'
        db.delete_column(u'exercises_categoryusage', 'tags')
    ...
    models = {
        ...
        u'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)'})
        },
