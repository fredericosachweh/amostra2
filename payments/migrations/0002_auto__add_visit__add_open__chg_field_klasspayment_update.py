...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Open'
        db.create_table(u'payments_open', (
        ...
        db.send_create_signal(u'payments', ['Open'])

        # Adding model 'Visit'
        db.create_table(u'payments_visit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.Payment'])),
            ('created_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'payments', ['Visit'])


        # Changing field 'KlassPayment.update_at'
        db.alter_column(u'payments_klasspayment', 'update_at', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting model 'Open'
        db.delete_table(u'payments_open')

        # Deleting model 'Visit'
        db.delete_table(u'payments_visit')


        # Changing field 'KlassPayment.update_at'
        db.alter_column(u'payments_klasspayment', 'update_at', self.gf('django.db.models.fields.DateField')(null=True))
