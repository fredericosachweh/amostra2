...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.pending_payment'
        db.add_column(u'clients_contract', 'pending_payment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.pending_payment'
        db.delete_column(u'clients_contract', 'pending_payment')
