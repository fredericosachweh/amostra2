...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Klass.cost'
        db.add_column(u'clients_klass', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default='70', max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Klass.cost'
        db.delete_column(u'clients_klass', 'cost')
