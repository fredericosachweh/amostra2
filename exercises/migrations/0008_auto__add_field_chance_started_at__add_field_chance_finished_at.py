...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chance.started_at'
        db.add_column('exercises_chance', 'started_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Chance.finished_at'
        db.add_column('exercises_chance', 'finished_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserBattery.battery_schedule'
        db.add_column('exercises_userbattery', 'battery_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercises.BatterySchedule'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chance.started_at'
        db.delete_column('exercises_chance', 'started_at')

        # Deleting field 'Chance.finished_at'
        db.delete_column('exercises_chance', 'finished_at')

        # Deleting field 'UserBattery.battery_schedule'
        db.delete_column('exercises_userbattery', 'battery_schedule_id')
