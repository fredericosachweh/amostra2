...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CategoryUsage', fields ['filter2_lower']
        db.create_index(u'exercises_categoryusage', ['filter2_lower'])

        # Adding index on 'CategoryUsage', fields ['filter1_lower']
        db.create_index(u'exercises_categoryusage', ['filter1_lower'])

        # Adding index on 'CategoryUsage', fields ['filter1_upper']
        db.create_index(u'exercises_categoryusage', ['filter1_upper'])

        # Adding index on 'CategoryUsage', fields ['filter2_upper']
        db.create_index(u'exercises_categoryusage', ['filter2_upper'])

        # Adding index on 'Exercise', fields ['filter1']
        db.create_index(u'exercises_exercise', ['filter1'])

        # Adding index on 'Exercise', fields ['filter2']
        db.create_index(u'exercises_exercise', ['filter2'])


    def backwards(self, orm):
        # Removing index on 'Exercise', fields ['filter2']
        db.delete_index(u'exercises_exercise', ['filter2'])

        # Removing index on 'Exercise', fields ['filter1']
        db.delete_index(u'exercises_exercise', ['filter1'])

        # Removing index on 'CategoryUsage', fields ['filter2_upper']
        db.delete_index(u'exercises_categoryusage', ['filter2_upper'])

        # Removing index on 'CategoryUsage', fields ['filter1_upper']
        db.delete_index(u'exercises_categoryusage', ['filter1_upper'])

        # Removing index on 'CategoryUsage', fields ['filter1_lower']
        db.delete_index(u'exercises_categoryusage', ['filter1_lower'])

        # Removing index on 'CategoryUsage', fields ['filter2_lower']
        db.delete_index(u'exercises_categoryusage', ['filter2_lower'])
    ...
    models = {
        ...
        u'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 0, 0)'})
        },
