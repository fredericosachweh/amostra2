...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'clients_client', 'supplement', 'complement')
        db.rename_column(u'clients_client', 'cep', 'postal_code')
        db.add_column(u'clients_client', 'quarter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)
        db.alter_column(u'clients_client', 'number', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):
        db.delete_column(u'clients_client', 'quarter')
        db.rename_column(u'clients_client', 'complement', 'supplement')
        db.rename_column(u'clients_client', 'postal_code', 'cep')
        db.alter_column(u'clients_client', 'number', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
