...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserBatteryExercise.is_correct'
        db.alter_column('exercises_userbatteryexercise', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True))
        # Adding field 'UserBattery.score'
        db.add_column('exercises_userbattery', 'score',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=5),
                      keep_default=False)

        # Adding field 'UserBattery.attempts_spent'
        db.add_column('exercises_userbattery', 'attempts_spent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=5),
                      keep_default=False)

        # Adding field 'UserBattery.time_spent'
        db.add_column('exercises_userbattery', 'time_spent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'AnswerType.next_group'
        db.alter_column('exercises_answertype', 'next_group', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Removing index on 'AnswerType', fields ['next_group']
        try:
            db.delete_index('exercises_answertype', ['next_group'])
        except utils.DatabaseError:
            pass  # sqlite3 doesn't supports index deletion


    def backwards(self, orm):
        # Adding index on 'AnswerType', fields ['next_group']
        db.create_index('exercises_answertype', ['next_group'])


        # Changing field 'UserBatteryExercise.is_correct'
        db.alter_column('exercises_userbatteryexercise', 'is_correct', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'UserBattery.score'
        db.delete_column('exercises_userbattery', 'score')

        # Deleting field 'UserBattery.attempts_spent'
        db.delete_column('exercises_userbattery', 'attempts_spent')

        # Deleting field 'UserBattery.time_spent'
        db.delete_column('exercises_userbattery', 'time_spent')


        # Changing field 'AnswerType.next_group'
        db.alter_column('exercises_answertype', 'next_group', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 2, 0, 0)'})
        },
        'exercises.question': {
