...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercise.tags'
        db.add_column('exercises_exercise', 'tags',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercise.tags'
        db.delete_column('exercises_exercise', 'tags')
    ...
    models = {
        ...
        'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 4, 0, 0)'})
        },
        'exercises.question': {
