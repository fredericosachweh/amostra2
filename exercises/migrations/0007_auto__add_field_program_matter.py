...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Program.matter'
        db.add_column('exercises_program', 'matter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exercises.Matter']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Program.matter'
        db.delete_column('exercises_program', 'matter_id')
