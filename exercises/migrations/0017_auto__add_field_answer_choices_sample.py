...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.choices_sample'
        db.add_column('exercises_answer', 'choices_sample',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.choices_sample'
        db.delete_column('exercises_answer', 'choices_sample')
    ...
    models = {
        ...
        'clients.klass': {
            ...
            'students': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'took_klasses'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
        ...
        'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)'})
        },
        'exercises.question': {
