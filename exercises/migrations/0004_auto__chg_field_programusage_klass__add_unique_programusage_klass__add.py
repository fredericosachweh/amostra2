...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProgramUsage.klass'
        db.alter_column('exercises_programusage', 'klass_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['clients.Klass'], unique=True))
        # Adding unique constraint on 'ProgramUsage', fields ['klass']
        db.create_unique('exercises_programusage', ['klass_id'])

        # Adding field 'Battery.categories_names'
        db.add_column('exercises_battery', 'categories_names',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ProgramUsage', fields ['klass']
        db.delete_unique('exercises_programusage', ['klass_id'])


        # Changing field 'ProgramUsage.klass'
        db.alter_column('exercises_programusage', 'klass_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Klass']))
        # Deleting field 'Battery.categories_names'
        db.delete_column('exercises_battery', 'categories_names')
    ...
    models = {
        ...
        'clients.client': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'managers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'exercises.programusage': {
            ...
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['clients.Contract']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'klass': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['clients.Klass']", 'unique': 'True'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercises.Program']"}),
