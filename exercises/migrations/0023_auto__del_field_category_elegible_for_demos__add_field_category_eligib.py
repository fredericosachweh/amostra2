...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'exercises_category', 'elegible_for_demos', 'eligible_for_demos')

    def backwards(self, orm):
        db.rename_column(u'exercises_category', 'eligible_for_demos', 'elegible_for_demos')
    ...
    models = {
        ...
        u'exercises.category': {
            ...
            'eligible_for_demos': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
