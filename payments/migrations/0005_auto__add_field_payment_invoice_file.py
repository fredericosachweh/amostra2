...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.invoice_file'
        db.add_column(u'payments_payment', 'invoice_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.invoice_file'
        db.delete_column(u'payments_payment', 'invoice_file')
