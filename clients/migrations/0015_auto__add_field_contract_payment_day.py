...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.payment_day'
        db.add_column(u'clients_contract', 'payment_day',
                      self.gf('django.db.models.fields.IntegerField')(default=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.payment_day'
        db.delete_column(u'clients_contract', 'payment_day')
