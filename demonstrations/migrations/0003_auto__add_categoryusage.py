...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'demonstrations_categoryusage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demonstration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demonstrations.Demonstration'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demonstrations_category_usages', to=orm['exercises.Category'])),
            ('chance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercises.Chance'], null=True, blank=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'demonstrations', ['CategoryUsage'])


    def backwards(self, orm):
        # Deleting model 'CategoryUsage'
        db.delete_table(u'demonstrations_categoryusage')
    ...
    models = {
        ...
        u'demonstrations.categoryusage': {
            'Meta': {'ordering': "('position',)", 'object_name': 'CategoryUsage'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'demonstrations_category_usages'", 'to': u"orm['exercises.Category']"}),
            'chance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.Chance']", 'null': 'True', 'blank': 'True'}),
            'demonstration': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['demonstrations.Demonstration']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'exercises.programusage': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.Program']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 16, 0, 0)'})
        },
        u'exercises.subject': {
