...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demonstration.has_agreed'
        db.add_column(u'demonstrations_demonstration', 'has_agreed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demonstration.has_agreed'
        db.delete_column(u'demonstrations_demonstration', 'has_agreed')
